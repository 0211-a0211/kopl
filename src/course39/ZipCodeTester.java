...
class ZipCodeException extends RuntimeException {
	ZipCodeException(String n) {
		super(n);
	}
}

public class ZipCodeTester {//ZipCodeExceptionRuntimeException
	...
	/*--- １桁（0～9）の整数aとbの和を求める ---*/
	static String addPostMark(String code) throws ZipCodeException {
		String result = null;
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("入力された郵便番号ではありません" + e.getMessage());
		}
	}
}
